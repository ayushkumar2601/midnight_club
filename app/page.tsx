...
const NAV_ITEMS = ['Play Now', 'How it Works', 'Zero Knowledge', 'Fairness', 'Leaderboard'];
  ...
  return (
    <>
      <nav className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-5 py-4 lg:px-10 lg:py-6">
        <span className="text-white text-xl font-semibold tracking-tighter uppercase" style={{ fontFamily: 'Inter, sans-serif' }}>
          MIDNIGHT CLUB
        </span>
    ...
    <div className="relative w-full h-screen overflow-hidden bg-black" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="relative z-20 flex flex-col items-center text-center pt-[90px] md:pt-[120px] px-5 sm:px-8">
        ...
        >
          ...
          {' '}Provably fair, entirely confidential.
        </h1>
        ...
        >
          the ultimate multiplayer protocol - where hidden hands
          <br className="hidden sm:block" />
          {' '}stay hidden and zero-knowledge guarantees fairness.
        </p>
