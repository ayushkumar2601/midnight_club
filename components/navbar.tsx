    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <button className="w-full py-3 rounded-full bg-white text-black text-sm font-medium transition-all duration-300 hover:opacity-80">
              Join the wait
            </button>
          </div>
        </div>
  ...
  return (
    <>
      <nav className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-5 py-4 lg:px-10 lg:py-6">
        <span className="text-white text-xl font-semibold tracking-tight">velorix</span>
        <div
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="hidden lg:block text-sm font-medium px-5 py-2 rounded-full bg-white text-black transition-all duration-300 hover:opacity-80">
            Join the wait
          </button>
        </div>
      </nav>
